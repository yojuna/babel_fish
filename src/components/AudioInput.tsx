...
function getAllMicDevices() {
    ...
    const mic_device: Dictionary = {};
    const audio_mic_devices : Dictionary[] = [];
    // let mic_device = {}
        ...
        navigator.mediaDevices
          ...
          .then((devices) => {
            devices.forEach((device) => {
              ...
              mic_device['kind'] = device.kind;
              mic_device['label'] = device.label;
              mic_device['id'] = device.deviceId;
              
              console.log("mic-device")
              console.log(mic_device)

              audio_mic_devices.push(mic_device)
...
//   updateAllDevices(getAllMicDevices())
